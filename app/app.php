...
class Entreprise_conf extends app{

    public $general = array(
        "Societe"       => "SAS CRIDIP",
        "Adresse"       => "8 Rue Octave Voyer",
        "Code_Postal"   => "85100",
        "Ville"         => "Les Sables d'Olonne",
        "Telephone"     => "0899 753 965",
        "Fax"           => "",
        "Email"         => "contact@cridip.com",
        "Siret"         => "811 722 229",
        "Num_TVA"       => "FR88 811722229",
        "Capital"       => "100,00 €"
    );

    public $activite = array(
        "Debut_activite"    => "1451606400", // Format strtotime
        "Pays"              => "France"
    );

    public $enseigne = array(
        "Enseigne"      => "SAS CRIDIP"
    );

    public $doc_general = array(
        "Delai_devis_client_recent"     => "604800", // Format calcul strtortime 84300 * nb_jour
        "Delai_devis_client_perime"     => "1296000",
...
class Annuaire_conf extends app{

    public $profil = array(
        "Profil1"   => "Administrateur",
        "Profil2"   => "Client",
        "Profil3"   => "Collaborateur",
        "Profil4"   => "Commercial",
        "Profil5"   => "Fournisseur",
        "profil6"   => "Visiteur"
    );

    public $cat_client = array(
        array(
            "Libelle"   => "Client Standard",
            "Encours"   => "0.00",
            "Delai_rglt"=> "0" //Format strtotime 84300*nb_jour
        )
    );
}
class Catalogue_conf extends app{
