    ...
    <section class="body-sign">
        <div class="center-sign">
            <a href="/" class="logo pull-left">
                <img src="assets/images/logo.png" height="54" alt="<?= \App\constante::NOM_SITE; ?>" />
            </a>
                    ...
                    <form action="<?= $constante->getUrl(array('core/'), false, false); ?>user.php" method="post">
                        ...
                        <div class="form-group mb-lg">
                            <div class="clearfix">
                                ...
                                <a href="login.php?sub=recorver-password" class="pull-right">Mot de passe perdu?</a>
                            </div>
                            <div class="input-group input-group-icon">
