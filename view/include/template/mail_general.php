...
<table align="center" cellpadding="0" cellspacing="0" width="100%" height="100%" >
    <tr>
        <td align="center" valign="top" style="background:#2b3d4e" width="100%">
            <center>
                        ...
                        <td align="center" valign="top">
                            ...
                            <table cellspacing="0" cellpadding="0" class="force-full-width" bgcolor="#ffffff" >
                                <tr>
                                    ...
                                    -webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px;">Review Account Settings</a>
                                                        <!--[if mso]>
                                                        </center>
                                                        </v:rect>
                                                        <![endif]-->
