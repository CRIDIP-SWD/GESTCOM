                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button data-rel="tooltip" type="button" id="supp-client" class="btn btn-sm btn-danger m-b-10 f-left btn-icon" data-toggle="tooltip" data-placement="top" title="Supprimer le client"><i class="fa fa-trash"></i> </button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
