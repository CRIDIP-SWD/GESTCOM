<div class="col-lg-10 col-md-9">
    <div class="row profil-header" >
        <div class="col-lg-9 col-md-12">
            <div class="row">
                <div class="col-xs-4 profil-img">
                    <img src="assets/images/profil_page/profile-img.jpg" alt="profil">
                </div>
        ...
        <div class="col-lg-3 col-md-12 user-friends">
            <div class="row m-r-0">
                <div class="col-sm-4">
                    <img src="assets/images/profil_page/friend1.jpg" class="img-responsive" alt="friend 1">
                </div>
                <div class="col-sm-4">
                    <img src="assets/images/profil_page/friend2.jpg" class="img-responsive" alt="friend 2">
                </div>
                <div class="col-sm-4">
                    <img src="assets/images/profil_page/friend3.jpg" class="img-responsive" alt="friend 3">
                </div>
            </div>
            <div class="row m-r-0">
                <div class="col-sm-4">
                    <img src="assets/images/profil_page/friend4.jpg" class="img-responsive" alt="friend 4">
                </div>
                <div class="col-sm-4">
                    <img src="assets/images/profil_page/friend5.jpg" class="img-responsive" alt="friend 5">
                </div>
                <div class="col-sm-4">
                    <img src="assets/images/profil_page/friend6.jpg" class="img-responsive" alt="friend 6">
                </div>
            </div>
            <div class="row m-r-0">
                <div class="col-sm-4">
                    <img src="assets/images/profil_page/friend7.jpg" class="img-responsive" alt="friend 7">
                </div>
                <div class="col-sm-4">
                    <img src="assets/images/profil_page/friend8.jpg" class="img-responsive" alt="friend 8">
                </div>
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <div class="item hover-effect">
                            <div class="user">
                                <img src="assets/images/profil_page/pics2.jpg" class="img-responsive hover-img" alt="">
                                <img src="assets/images/profil_page/friend8.jpg" class="img-user" alt="picture 2">
                                <div class="info">
                            ...
                            <div class="more">
                                ...
                                <div class="row comments">
                                  ...
                                  <img src="assets/images/profil_page/friend1.jpg" alt="friend 1">
                                  </span>
                                                <div class="clearfix">
                                                    <div class="info">
                                            ...
                                            <li class="clearfix">
                                  <span class="pull-left">
                                  <img src="assets/images/profil_page/friend2.jpg" alt="friend 2">
                                  </span>
                                                <div class="clearfix">
                                                    <div class="info">
                                                        <div class="name"><strong class="primary-font">John Smith</strong></div>
                        ...
                        <div class="item hover-effect">
                            <div class="user">
                                <img src="assets/images/profil_page/pics3.jpg" class="img-responsive hover-img" alt="">
                                <img src="assets/images/profil_page/friend4.jpg" class="img-user" alt="picture 2">
                                <div class="info">
                                ...
                                <div class="row comments">
                                    <div class="col-sm-12">
                                        <ul>
                                            <li class="clearfix">
                                  <span class="pull-left">
                                  <img src="assets/images/profil_page/friend5.jpg" alt="friend 1">
                                  </span>
                                                <div class="clearfix">
                                                    <div class="info">
                                            ...
                                            <li class="clearfix">
                                  <span class="pull-left">
                                  <img src="assets/images/profil_page/friend6.jpg" alt="friend 2">
                                  </span>
                                                <div class="clearfix">
                                                    <div class="info">
                                                        <div class="name"><strong class="primary-font">John Smith</strong></div>
                    ...
                    <div class="col-sm-7">
                        <div class="item item-comment">
                            <div class="user">
                                <img alt="Profile Image" src="assets/images/profil_page/friend2.jpg">
                            ...
                            <div class="widget-slider-img">
                                <div class="slick" data-fade="true" data-dots="false">
                                    ...
                                    <div class="slide opacity-70">
                                        <img src="assets/images/gallery/2.jpg" alt="1">
                                        <div class="text">
                                            <p>At the beach</p>
                                        </div>
                                    </div>
            ...
            <div class="col-md-5">
                <div class="row">
                    <div class="col-md-12 col-sm-6 col-xs-12">
                        ...
                        <div class="item hover-effect">
                            <div class="user">
                                <img src="assets/images/profil_page/pics1.jpg" class="img-responsive hover-img" alt="">
                                <img src="assets/images/profil_page/friend7.jpg" class="img-user" alt="picture 2">
                                <div class="info">
                                ...
                                <div class="row comments">
                                    <div class="col-sm-12">
                                        <ul>
                                            <li class="clearfix">
                                  <span class="pull-left">
                                  <img src="assets/images/profil_page/friend4.jpg" alt="friend 1">
                                  </span>
                                                <div class="clearfix">
                                                    <div class="info">
                                                        <div class="name"><strong class="primary-font">John Smith</strong></div>
