                                    ...
                                    <table class="table dataTable" id="today2">
                                        ...
                                        ?>
                                            <tr class="<?php if($event->start_event < time() AND $event->end_event < time()){echo 'danger';} ?> <?php if($event->start_event <= time()-900){echo 'info';} ?>">
                                                ...
                                                <td class="">
                                                    <button type="button" class="btn btn-sm btn-icon btn-rounded btn-danger"><i class="fa fa-trash"></i></button>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    ...
                                    <table class="table dataTable" id="week2">
                                        ...
                                        foreach($sql_event as $event):
                                            ...
                                            <tr class="<?php if($event->start_event < time() AND $event->end_event < time()){echo 'danger';} ?> <?php if($event->start_event <= time()-900){echo 'info';} ?>">
                                                ...
                                                <td>
                                                    <a href="controller/calendar.php?action=supp-event&idevent=<?= $event->idevent; ?>" class="btn btn-sm btn-icon btn-rounded btn-danger"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                        </tbody>
